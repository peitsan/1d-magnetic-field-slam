function [filename]=collectRosData(bagPath)
    % 初始化存储变量
    clear, close all, clc
    rosshutdown
...
%     if nargin > 0
%         bag = rosbag(bagPath);
%         bagSelect = select(bag, 'Topic', {'/imu/data', '/imu/mag', '/imu/time_ref', '/imu2odom_node/imu_odometry', '/filter/quaternion'});
...
%             switch msg.Topic
%                 case '/imu/data'
%                     processImuData([], msg.Message);
%                 case '/imu/mag'
%                     processMag([], msg.Message);
%                 case '/imu/time_ref'
%                     processTimeRef([], msg.Message);
%                 case '/imu2odom_node/imu_odometry'
%                     processOdom([], msg.Message);
%                 case '/filter/quaternion'
%                     processQuat([], msg.Message);
%             end
%         end
%     end
